...
module.exports = {
  ...
  factory: function(require) {
    var plugin = (() => {
      ...
      var tt = (e, t, r) => t in e ? ge(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r,
        I = (e, t) => {
      ...
      var K = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
        ...
        Nr = (e, t, r) => {
          if (t && typeof t == "object" || typeof t == "function") {
            for (let n of $r(t)) {
              !et.call(e, n) && n !== "default"
                && ge(e, n, { get: () => t[n], enumerable: !(r = vr(t, n)) || r.enumerable });
            }
          }
          return e;
        },
      ...
      var He = K(ee => {
        ...
        ee.exceedsLimit = (e, t, r = 1, n) =>
          n === !1 || !ee.isInteger(e) || !ee.isInteger(t) ? !1 : (Number(t) - Number(e)) / Number(r) >= n;
      ...
      var $e = K((is, st) => {
        ...
        st.exports = (e, t = {}) => {
          let r = (n, s = {}) => {
            let a = t.escapeInvalid && at.isInvalidBrace(s), i = n.invalid === !0 && t.escapeInvalid === !0, o = "";
      ...
      var mt = K((us, ut) => {
        ...
        var ct = ot(),
          pe = (e, t, r) => {
            ...
            let R = pt(e) || pt(t), p = { min: e, max: t, a: m, b: f }, v = [], _ = [];
            if (R && (p.isPadded = R, p.maxLen = String(p.max).length), m < 0) {
              let y = f < 0 ? Math.abs(f) : 1;
              _ = lt(y, Math.abs(m), p, n), m = p.a = 0;
            }
            return f >= 0 && (v = lt(m, f, p, n)),
              p.negatives = _,
              p.positives = v,
              p.result = Ir(_, v, n),
              n.capture === !0
                ? p.result = `(${p.result})`
                : n.wrap !== !1 && v.length + _.length > 1 && (p.result = `(?:${p.result})`),
              pe.cache[h] = p,
              p.result;
          };
        function Ir(e, t, r) {
        ...
        var qr = require("util"),
          ...
          Xr = (e, t, r = 1, n = {}) => {
            ...
            let _ = { negatives: [], positives: [] },
              ...
              E = 0;
            for (; i ? s >= a : s <= a;) {
              n.toRegex === !0 && r > 1 ? y(s) : b.push(jr(v(s, E), R, p)), s = i ? s - r : s + r, E++;
            }
          ...
          ke = (e, t, r, n = {}) => {
            ...
            let s = I({}, n);
            return s.capture === !0 && (s.wrap = !0),
              r = r || s.step || 1,
              Ae(r)
                ? Ae(e) && Ae(t) ? Xr(e, t, r, s) : Zr(e, t, Math.max(Math.abs(r), 1), s)
                : r != null && !yt(r)
                ? Qr(r, s)
                : ke(e, t, 1, r);
          };
          ...
          zr = (e, t = {}) => {
            let r = (n, s = {}) => {
              ...
              if (n.nodes && n.ranges > 0) {
                let f = St.reduce(n.nodes), R = Yr(...f, F(I({}, t), { wrap: !1, toRegex: !0 }));
          ...
          fe = (e = "", t = "", r = !1) => {
            ...
            for (let s of e) {
              if (Array.isArray(s)) for (let a of s) n.push(fe(a, t, r));
                ...
                for (let a of t) {
                  r === !0 && typeof a == "string" && (a = `{${a}}`), n.push(Array.isArray(a) ? fe(s, a, r) : s + a);
                }
              }
            }
            return he.flatten(n);
...
`,
      ...
      var Mt = K((hs, Ot) => {
        ...
        var en = $e(),
          ...
          hn = (e, t = {}) => {
            ...
            let r = t || {}, n = typeof r.maxLength == "number" ? Math.min(Nt, r.maxLength) : Nt;
            ...
            for (y({ type: "bos" }); f < m;) {
              if (i = a[a.length - 1], p = _(), !(p === fn || p === pn)) {
                if (p === qe) {
                ...
                if (p === sn) {
                  i = y({ type: "paren", nodes: [] }), a.push(i), y({ type: "text", value: p });
                  continue;
                }
                if (p === an) {
                  if (i.type !== "paren") {
                ...
                if (p === on) {
                  ...
                  i = y({ type: "brace", open: !0, close: !1, dollar: b, depth: R, commas: 0, ranges: 0, nodes: [] }),
                    a.push(i),
                    y({ type: "open", value: p });
                  continue;
                }
                if (p === un) {
                  ...
                  let b = "close";
                  i = a.pop(), i.close = !0, y({ type: b, value: p }), R--, i = a[a.length - 1];
                  continue;
                }
                if (p === rn && R > 0) {
                  if (i.ranges > 0) {
      ...
      var ye = K(X => {
        "use strict";
        var $n = require("path"),
          kn = process.platform === "win32",
          { REGEX_BACKSLASH: Tn, REGEX_REMOVE_BACKSLASH: Ln, REGEX_SPECIAL_CHARS: On, REGEX_SPECIAL_CHARS_GLOBAL: Nn } =
            Re();
        ...
        var Qt = ye(),
          ...
          Un = (e, t) => {
            ...
            for (; m < n;) {
              ...
              if (g === Zt) {
                if (a.push(m), i.push(w), w = { value: "", depth: 0, isGlob: !1 }, k === !0) continue;
                if (ie === Fe && m === f + 1) {
                  f += 2;
                  continue;
                }
            ...
            r.noext === !0 && (y = !1, _ = !1);
            let x = h, T = "", U = "";
            f > 0 && (T = h.slice(0, f), h = h.slice(f), R -= f),
              x && _ === !0 && R > 0 ? (x = h.slice(0, R), U = h.slice(R)) : _ === !0 ? (x = "", U = h) : x = h,
              x && x !== "" && x !== "/" && x !== h && Vt(x.charCodeAt(x.length - 1)) && (x = x.slice(0, -1)),
              r.unescape === !0 && (U && (U = Qt.removeBackslashes(U)), x && H === !0 && (x = Qt.removeBackslashes(x)));
            let u = {
              prefix: T,
              input: e,
              start: f,
            ...
            if (
              r.tokens === !0 && (u.maxDepth = 0, Vt(g) || i.push(w), u.tokens = i), r.parts === !0 || r.tokens === !0
            ) {
              let c;
              for (let $ = 0; $ < a.length; $++) {
                let B = c ? c + 1 : f, Y = a[$], re = e.slice(B, Y);
                r.tokens
                && ($ === 0 && f !== 0 ? (i[$].isPrefix = !0, i[$].value = T) : i[$].value = re,
                  Jt(i[$]),
                  u.maxDepth += i[$].depth),
                  ($ !== 0 || re !== "") && o.push(re),
                  c = Y;
              ...
              if (c && c + 1 < e.length) {
                let $ = e.slice(c + 1);
                o.push($),
                  r.tokens && (i[i.length - 1].value = $, Jt(i[i.length - 1]), u.maxDepth += i[i.length - 1].depth);
              }
      ...
      var sr = K((Rs, tr) => {
        ...
        var Le = Re(),
          ...
          nr = (e, t) => {
            if (typeof e != "string") throw new TypeError("Expected a string");
            e = rr[e] || e;
            let r = I({}, t), n = typeof r.maxLength == "number" ? Math.min(Oe, r.maxLength) : Oe, s = e.length;
            ...
            let x = [],
              ...
              C = A => {
                ...
                if (
                  x.length && A.type !== "paren" && !f[A.value] && (x[x.length - 1].inner += A.value),
                    (A.value || A.output) && xe(A),
                    u && u.type === "text" && A.type === "text"
                ) {
              ...
              we = (A, O) => {
                ...
                Ce("parens"),
                  C({ type: A, value: O, output: l.output ? "" : _ }),
                  C({ type: "paren", extglob: !0, value: Y(), output: S }),
                  x.push(d);
              },
              Cr = A => {
                ...
                if (A.type === "negate") {
                  let d = W;
                  A.inner && A.inner.length > 1 && A.inner.includes("/") && (d = g(r)),
                    (d !== W || $() || /^\)+$/.test(re())) && (O = A.close = `)$))${d}`),
                    A.prev.type === "bos" && (l.negatedExtglob = !0);
                }
                C({ type: "paren", extglob: !0, value: c, output: O }), ce("parens");
              };
            if (r.fastpaths !== !1 && !/(^[*!]|[/()[\]{}"])/.test(e)) {
              let A = !1,
                O = e.replace(Wn, (d, S, M, j, q, Me) =>
                  j === "\\"
                    ? (A = !0, d)
                    : j === "?"
                    ? S
                      ? S + j + (q ? L.repeat(q.length) : "")
                      : Me === 0
                      ? D + (q ? L.repeat(q.length) : "")
                      : L.repeat(M.length)
                    : j === "."
                    ? R.repeat(M.length)
                    : j === "*"
                    ...
                    ? d
                    : `\\${d}`);
              return A === !0 && (r.unescape === !0
                ? O = O.replace(/\\/g, "")
                : O = O.replace(/\\+/g, d => d.length % 2 == 0 ? "\\\\" : d ? "\\" : "")),
                O === e && r.contains === !0 ? (l.output = e, l) : (l.output = V.wrapOutput(O, l, t), l);
            }
            for (; !$();) {
              if (c = Y(), c === "\0") continue;
              if (c === "\\") {
                ...
                let S = /^\\+/.exec(re()), M = 0;
                if (
                  S && S[0].length > 2 && (M = S[0].length, l.index += M, M % 2 != 0 && (c += "\\")),
                    r.unescape === !0 ? c = Y() || "" : c += Y() || "",
                    l.brackets === 0
                ) {
                  C({ type: "text", value: c });
                  continue;
              ...
              if (l.brackets > 0 && (c !== "]" || u.value === "[" || u.value === "[^")) {
                if (r.posix !== !1 && c === ":") {
                  ...
                  if (d.includes("[") && (u.posix = !0, d.includes(":"))) {
                    let S = u.value.lastIndexOf("["), M = u.value.slice(0, S), j = u.value.slice(S + 2), q = qn[j];
                    if (q) {
                ...
                (c === "[" && B() !== ":" || c === "-" && B() === "]") && (c = `\\${c}`),
                  c === "]" && (u.value === "[" || u.value === "[^") && (c = `\\${c}`),
                  r.posix === !0 && c === "!" && u.value === "[" && (c = "^"),
                  u.value += c,
                  xe({ value: c });
                continue;
              }
              ...
              if (c === "\"") {
                l.quotes = l.quotes === 1 ? 0 : 1, r.keepQuotes === !0 && C({ type: "text", value: c });
                continue;
              }
              if (c === "(") {
              ...
              if (c === ")") {
                ...
                C({ type: "paren", value: c, output: l.parens ? ")" : "\\)" }), ce("parens");
                continue;
              }
              if (c === "[") {
              ...
              if (c === "}") {
                ...
                if (d.dots === !0) {
                  let M = i.slice(), j = [];
                  for (let q = M.length - 1; q >= 0 && (i.pop(), M[q].type !== "brace"); q--) {
                    M[q].type !== "dots" && j.unshift(M[q].value);
                  }
              ...
              if (c === "|") {
                x.length > 0 && x[x.length - 1].conditions++, C({ type: "text", value: c });
                continue;
              }
              if (c === ",") {
                let d = c, S = T[T.length - 1];
                S && U[U.length - 1] === "braces" && (S.comma = !0, d = "|"), C({ type: "comma", value: c, output: d });
                continue;
              }
              if (c === "/") {
              ...
              if (c === "?") {
                ...
                if (u && u.type === "paren") {
                  let S = B(), M = c;
                  if (S === "<" && !V.supportsLookbehinds()) {
                    throw new Error("Node.js v10 or higher is required for regex lookbehinds");
                  }
                  (u.value === "(" && !/[!=<:]/.test(S) || S === "<" && !/<([!=]|\w+>)/.test(re())) && (M = `\\${c}`),
                    C({ type: "text", value: c, output: M });
                  continue;
                }
              ...
              if (c !== "*") {
                (c === "$" || c === "^") && (c = `\\${c}`);
                let d = Kn.exec(re());
                d && (c += d[0], l.index += d[0].length), C({ type: "text", value: c });
                continue;
              }
              ...
              if (u.type === "star") {
                ...
                if (d.type === "slash" && d.prev.type !== "bos" && !j && $()) {
                  l.output = l.output.slice(0, -(d.output + u.output).length),
                    d.output = `(?:${d.output}`,
                    u.type = "globstar",
                    u.output = g(r) + (r.strictSlashes ? ")" : "|$)"),
                    u.value += c,
                    l.globstar = !0,
                    l.output += d.output + u.output,
                    oe(c);
                  continue;
                }
              ...
              (l.index === l.start || u.type === "slash" || u.type === "dot")
              && (u.type === "dot"
                ? (l.output += E, u.output += E)
                : r.dot === !0
                ? (l.output += H, u.output += H)
                : (l.output += w, u.output += w),
                B() !== "*" && (l.output += _, u.output += _)), C(O);
            }
            for (; l.brackets > 0;) {
            ...
            if (
              r.strictSlashes !== !0 && (u.type === "star" || u.type === "bracket")
              && C({ type: "maybe_slash", value: "", output: `${v}?` }), l.backtrack === !0
            ) {
              l.output = "";
              for (let A of l.tokens) {
                l.output += A.output != null ? A.output : A.value, A.suffix && (l.output += A.suffix);
              }
            }
            return l;
          };
      ...
      var ir = K((ys, ar) => {
        ...
        var Fn = require("path"),
          ...
          P = (e, t, r = !1) => {
            ...
            let s = t || {}, a = Ye.isWindows(t), i = n ? P.compileRe(e, t) : P.makeRe(e, t, !1, !0), o = i.state;
            delete i.state;
            let h = () => !1;
            if (s.ignore) {
              let f = F(I({}, t), { ignore: null, onMatch: null, onResult: null });
              h = P(s.ignore, f, r);
            }
            let m = (f, R = !1) => {
              let { isMatch: p, match: v, output: _ } = P.test(f, i, t, { glob: e, posix: a }),
                y = { glob: e, state: o, regex: i, posix: a, input: f, output: _, match: v, isMatch: p };
              return typeof s.onResult == "function" && s.onResult(y),
                p === !1
                  ? (y.isMatch = !1, R ? y : !1)
                  : h(f)
                  ? (typeof s.onIgnore == "function" && s.onIgnore(y), y.isMatch = !1, R ? y : !1)
                  : (typeof s.onMatch == "function" && s.onMatch(y), R ? y : !0);
            };
        ...
        P.test = (e, t, r, { glob: n, posix: s } = {}) => {
          ...
          let a = r || {}, i = a.format || (s ? Ye.toPosixSlashes : null), o = e === n, h = o && i ? i(e) : e;
          return o === !1 && (h = i ? i(e) : e, o = h === n),
            (o === !1 || a.capture === !0)
            && (a.matchBase === !0 || a.basename === !0 ? o = P.matchBase(e, t, r, s) : o = t.exec(h)),
        ...
        P.makeRe = (e, t, r = !1, n = !1) => {
          ...
          return e.startsWith("./") && (e = e.slice(2), i = a.prefix = "./"),
            s.fastpaths !== !1 && (e[0] === "." || e[0] === "*") && (o = Ze.fastpaths(e, t)),
            o === void 0 ? (a = Ze(e, t), a.prefix = i + (a.prefix || "")) : a.output = o,
            P.compileRe(a, t, r, n);
        };
        P.toRegex = (e, t) => {
          try {
        ...
        var lr = require("util"),
          ...
          N = (e, t, r) => {
            ...
            for (let f = 0; f < t.length; f++) {
              let R = ae(String(t[f]), F(I({}, r), { onResult: o }), !0), p = R.state.negated || R.state.negatedExtglob;
              p && i++;
              for (let v of e) {
                let _ = R(v, !0);
      ...
      var Ar = K((xs, Ve) => {
        ...
        var Yn = gr(),
          mr = e => {
            ...
            return Object.defineProperties(i, { activeCount: { get: () => r }, pendingCount: { get: () => t.length } }),
              i;
          };
        Ve.exports = mr;
      ...
      var Vn = {};
      Or(Vn, { default: () => es });
      var ve = Q(require("@yarnpkg/cli")),
        ne = Q(require("@yarnpkg/core")),
        rt = Q(require("@yarnpkg/core")),
        le = Q(require("clipanion")),
        me = class extends ve.BaseCommand {
          ...
          async execute() {
            let t = await ne.Configuration.find(this.context.cwd, this.context.plugins),
              { project: r, workspace: n } = await ne.Project.find(t, this.context.cwd),
            ...
            for (let o of a) {
              for (let h of this.production ? ["dependencies"] : ne.Manifest.hardDependencies) {
                for (let m of o.manifest.getForScope(h).values()) {
            ...
            for (let o of r.workspaces) {
              a.has(o)
                ...
                : (o.manifest.installConfig = o.manifest.installConfig || {},
                  o.manifest.installConfig.selfReferences = !1,
      ...
      me.paths = [["workspaces", "focus"]],
        me.usage = le.Command.Usage({
      ...
      var nt = me;
      var Ne = Q(require("@yarnpkg/cli")),
        Ie = Q(require("@yarnpkg/core")),
        be = Q(require("@yarnpkg/core")),
        Z = Q(require("@yarnpkg/core")),
        Rr = Q(require("@yarnpkg/plugin-git")),
        G = Q(require("clipanion")),
        Be = Q(hr()),
        yr = Q(require("os")),
        _r = Q(Ar()),
        te = Q(require("typanion")),
        Ee = class extends Ne.BaseCommand {
          constructor() {
            super(...arguments);
            this.recursive = G.Option.Boolean("-R,--recursive", !1, {
              description: "Find packages via dependencies/devDependencies instead of using the workspaces field",
            });
            this.from = G.Option.Array("--from", [], {
              description: "An array of glob pattern idents from which to base any recursion",
            });
            this.all = G.Option.Boolean("-A,--all", !1, {
              description: "Run the command on all workspaces of a project",
            });
            this.verbose = G.Option.Boolean("-v,--verbose", !1, {
            ...
            this.interlaced = G.Option.Boolean("-i,--interlaced", !1, {
          ...
          async execute() {
            let t = await Ie.Configuration.find(this.context.cwd, this.context.plugins),
              { project: r, workspace: n } = await Ie.Project.find(t, this.context.cwd);
            ...
            let s = this.cli.process([this.commandName, ...this.args]),
              a = s.path.length === 1 && s.path[0] === "run" && typeof s.scriptName != "undefined"
                ? s.scriptName
                : null;
            if (s.path.length === 0) {
            ...
            let i = this.all ? r.topLevelWorkspace : n,
              o = this.since
                ? Array.from(await Rr.gitUtils.fetchChangedWorkspaces({ ref: this.since, project: r }))
              ...
              f = new Set([
                ...
                ...m.map(g => [
                  ...this.recursive
                    ? this.since ? g.getRecursiveWorkspaceDependents() : g.getRecursiveWorkspaceDependencies()
                    : g.getRecursiveWorkspaceChildren(),
                ]).flat(),
              ]),
              R = [],
              p = !1;
            if (a == null ? void 0 : a.includes(":")) {
              for (let g of r.workspaces) {
                if (g.manifest.scripts.has(a) && (p = !p, p === !1)) break;
              }
            }
            for (let g of f) {
              a && !g.manifest.scripts.has(a) && !p
                || a === process.env.npm_lifecycle_event && g.cwd === n.cwd
                || this.include.length > 0 && !Be.default.isMatch(Z.structUtils.stringifyIdent(g.locator), this.include)
                || this.exclude.length > 0 && Be.default.isMatch(Z.structUtils.stringifyIdent(g.locator), this.exclude)
                || this.publicOnly && g.manifest.private === !0 || R.push(g);
            }
            let v = this.parallel
                ? this.jobs === "unlimited" ? Infinity : this.jobs || Math.max(1, (0, yr.cpus)().length / 2)
                : 1,
              _ = v === 1 ? !1 : this.parallel,
              y = _ ? this.interlaced : !0,
              b = (0, _r.default)(v),
              E = new Map(),
              H = new Set(),
              L = 0,
              k = null,
              J = !1,
              ie = await be.StreamReport.start({ configuration: t, stdout: this.context.stdout }, async g => {
                let w = async (D, { commandIndex: W }) => {
                  if (J) return -1;
                  !_ && this.verbose && W > 1 && g.reportSeparator();
                  let l = zn(D, { configuration: t, verbose: this.verbose, commandIndex: W }),
                    [x, T] = br(g, { prefix: l, interlaced: y }),
                    [U, u] = br(g, { prefix: l, interlaced: y });
                  try {
                    this.verbose && g.reportInfo(null, `${l} Process started`);
                    let c = Date.now(),
                      $ = await this.cli.run([this.commandName, ...this.args], { cwd: D.cwd, stdout: x, stderr: U })
                        || 0;
                    x.end(), U.end(), await T, await u;
                    let B = Date.now();
                    if (this.verbose) {
                      let Y = t.get("enableTimers")
                        ? `, completed in ${Z.formatUtils.pretty(t, B - c, Z.formatUtils.Type.DURATION)}`
                        : "";
                ...
                for (; E.size > 0 && !g.hasErrors();) {
                  ...
                  for (let [x, T] of E) {
                    ...
                    if (this.topological || this.topologicalDev) {
                      let u = this.topologicalDev
                        ? new Map([...T.manifest.dependencies, ...T.manifest.devDependencies])
                    ...
                    if (
                      !!U && (H.add(T.anchoredDescriptor.descriptorHash),
                        D.push(b(async () => {
                  ...
                  k === null && (k = typeof l != "undefined" ? 1 : k),
                    (this.topological || this.topologicalDev) && typeof l != "undefined"
                    && g.reportError(
                      be.MessageName.UNNAMED,
      ...
      Ee.paths = [["workspaces", "foreach"]],
        Ee.usage = G.Command.Usage({
          category: "Workspace-related commands",
          ...
          examples: [
            ["Publish current and all descendant packages", "yarn workspaces foreach npm publish --tolerate-republish"],
