...
module.exports = {
  ...
  factory: function(require) {
    var plugin = (() => {
      ...
      var Re = (e, t, r) => t in e ? H(e, t, { enumerable: !0, configurable: !0, writable: !0, value: r }) : e[t] = r,
        u = (e, t) => {
      ...
      var I = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
        ...
        Qt = (e, t, r) => {
          if (t && typeof t == "object" || typeof t == "function") {
            for (let s of Gt(t)) {
              !ne.call(e, s) && s !== "default"
                && H(e, s, { get: () => t[s], enumerable: !(r = Kt(t, s)) || r.enumerable });
            }
          }
          return e;
        },
      ...
      var Ce = I(M => {
        ...
        var rr = "4.2.0",
          sr = e => () => e.transporter.requester.destroy(),
      ...
      var Ze = I(A => {
        ...
        var or = ({ isTimedOut: e, status: t }) => !e && ~~t == 0,
          ir = e => {
            let t = e.status;
            ...
            p = (h, S) => {
              ...
              let P = {
                ...
                v = {
                  ...
                  onRetry(j) {
                    let T = x(j);
                    return j.isTimedOut && f++,
                      Promise.all([
                        e.logger.info("Retryable failure", pe(T)),
                        e.hostsCache.set(O, ue(O, j.isTimedOut ? U.Timeouted : U.Down)),
                      ]).then(() => p(h, S));
                  },
                  onFail(j) {
                    throw x(j), ze(j, de(n));
        ...
        function lr(e) {
          let {
            ...
            p = {
              ...
              hosts: y.map(h => le(h)),
              read(h, S) {
                let O = ce(S, p.timeouts.read), P = () => Qe(p, p.hosts.filter(j => (j.accept & X.Read) != 0), h, O);
                ...
                return p.responsesCache.get(
                  ...
                  () =>
                    p.requestsCache.get(
                      v,
                      () =>
                        p.requestsCache.set(v, P()).then(j => Promise.all([p.requestsCache.delete(v), j]), j =>
                          Promise.all([p.requestsCache.delete(v), Promise.reject(j)])).then(([j, T]) =>
                            T
                          ),
                    ),
                  { miss: j => p.responsesCache.set(v, j) },
                );
              },
              write(h, S) {
      ...
      var tt = I(w => {
        ...
        var N = F(),
          ...
          hr = e => {
            let t = e.region || "us",
              r = N.createAuth(N.AuthMode.WithinHeaders, e.appId, e.apiKey),
              s = mr.createTransporter(
                g(u({ hosts: [{ url: `analytics.${t}.algolia.com` }] }, e), {
          ...
          gr = e =>
            (t, r) => e.transporter.write({ method: z.MethodEnum.Delete, path: N.encode("2/abtests/%s", t) }, r),
          fr = e => (t, r) => e.transporter.read({ method: z.MethodEnum.Get, path: N.encode("2/abtests/%s", t) }, r),
          br = e => t => e.transporter.read({ method: z.MethodEnum.Get, path: "2/abtests" }, t),
          Pr = e =>
            (t, r) => e.transporter.write({ method: z.MethodEnum.Post, path: N.encode("2/abtests/%s/stop", t) }, r);
        w.addABTest = yr;
      ...
      var at = I(G => {
        ...
        var me = F(),
          ...
          Or = e => {
            let t = e.region || "us",
              r = me.createAuth(me.AuthMode.WithinHeaders, e.appId, e.apiKey),
              s = jr.createTransporter(
                g(u({ hosts: [{ url: `recommendation.${t}.algolia.com` }] }, e), {
                  headers: u(g(u({}, r.headers()), { "content-type": "application/json" }), e.headers),
                  queryParameters: u(u({}, r.queryParameters()), e.queryParameters),
                }),
              );
          ...
          Ir = e => t => e.transporter.read({ method: nt.MethodEnum.Get, path: "1/strategies/personalization" }, t),
          Ar = e =>
            (t, r) =>
              e.transporter.write({ method: nt.MethodEnum.Post, path: "1/strategies/personalization", data: t }, r);
      ...
      var jt = I(i => {
        ...
        function Y(e) {
          let t = r =>
            e.request(r).then(s => {
              if (e.batch !== void 0 && e.batch(s.hits), !e.shouldStop(s)) {
                return s.cursor
                  ? t({ cursor: s.cursor })
                  : t({ page: (r.page || 0) + 1 });
              }
        ...
        var Dr = e => {
          let t = e.appId,
            ...
            s = q.createTransporter(
              g(
                u({
                  hosts: [{ url: `${t}-dsn.algolia.net`, accept: q.CallEnum.Read }, {
                    url: `${t}.algolia.net`,
                    accept: q.CallEnum.Write,
                  }].concat(
                    l.shuffle([{ url: `${t}-1.algolianet.com` }, { url: `${t}-2.algolianet.com` }, {
        ...
        var Rr = e =>
            (t, r) => {
              ...
              return l.createWaitablePromise(
                e.transporter.write({ method: m.MethodEnum.Post, path: "1/keys", data: a }, n),
                o,
              );
            },
          vr = e =>
            (t, r, s) => {
              ...
              return n.queryParameters["X-Algolia-User-ID"] = t,
                e.transporter.write({ method: m.MethodEnum.Post, path: "1/clusters/mapping", data: { cluster: r } }, n);
            },
          xr = e =>
            (t, r, s) =>
              e.transporter.write({
          ...
          Tr = e => (t, r, s) => Z(e)(t, r, g(u({}, s), { scope: [ee.Synonyms] })),
          Mr = e =>
            (t, r) => {
              let s = (n, a) =>
              ...
              return l.createWaitablePromise(
                e.transporter.write({ method: m.MethodEnum.Delete, path: l.encode("1/keys/%s", t) }, r),
                s,
              );
            },
          wr = () =>
          ...
          kr = e => t => e.transporter.read({ method: m.MethodEnum.Get, path: "1/logs" }, t),
          Cr = () =>
            e => {
          ...
          Nr = e =>
            (t, r) => e.transporter.read({ method: m.MethodEnum.Get, path: l.encode("1/clusters/mapping/%s", t) }, r),
          Wr = e =>
            t => {
              let n = t || {}, { retrieveMappings: r } = n, s = R(n, ["retrieveMappings"]);
              return r === !0 && (s.getClusters = !0),
                e.transporter.read({ method: m.MethodEnum.Get, path: "1/clusters/mapping/pending" }, s);
            },
          L = e =>
            (t, r = {}) => {
          ...
          zr = e =>
            (t, r) => {
              let s = (n, a) =>
                Promise.all(
                  Object.keys(n.taskID).map(o => L(e)(o, { methods: { waitTask: D } }).waitTask(n.taskID[o], a)),
                );
              return l.createWaitablePromise(
                e.transporter.write({ method: m.MethodEnum.Post, path: "1/indexes/*/batch", data: { requests: t } }, r),
                s,
              );
            },
          Gr = e =>
            (t, r) =>
              e.transporter.read({ method: m.MethodEnum.Post, path: "1/indexes/*/objects", data: { requests: t } }, r),
          $r = e =>
            (t, r) => {
          ...
          Lr = e =>
            (t, r) =>
              Promise.all(t.map(s => {
                ...
                return L(e)(s.indexName, { methods: { searchForFacetValues: dt } }).searchForFacetValues(
                  n,
                  a,
                  u(u({}, r), o),
                );
          ...
          Vr = e =>
            (t, r) => {
              ...
              return s.queryParameters["X-Algolia-User-ID"] = t,
                e.transporter.write({ method: m.MethodEnum.Delete, path: "1/clusters/mapping" }, s);
            },
          Qr = e =>
            (t, r) => {
              let s = (n, a) =>
              ...
              return l.createWaitablePromise(
                e.transporter.write({ method: m.MethodEnum.Post, path: l.encode("1/keys/%s/restore", t) }, r),
                s,
              );
            },
          Jr = e =>
            (t, r) =>
              e.transporter.read(
                { method: m.MethodEnum.Post, path: "1/clusters/mapping/search", data: { query: t } },
                r,
              ),
          Xr = e =>
            (t, r) => {
              ...
              return l.createWaitablePromise(
                e.transporter.write({ method: m.MethodEnum.Put, path: l.encode("1/keys/%s", t), data: o }, a),
                b,
              );
            },
          pt = e =>
              ...
              return Y(g(u({}, r), {
                ...
                request(s) {
                  return mt(e)("", u(u({}, r), s)).then(n =>
                    g(u({}, n), { hits: n.hits.map(a => (delete a._highlightResult, a)) })
                  );
                },
              }));
            },
                ...
                d = (b = 0) => {
                  ...
                  return f.length === 0
                    ...
                    : pt(e)(f.map(h => ({ action: r, body: h })), a).then(
                      h => (o.objectIDs = o.objectIDs.concat(h.objectIDs), o.taskIDs.push(h.taskID), p++, d(p)),
                    );
                };
          ...
          ts = e =>
            t =>
              l.createWaitablePromise(
                e.transporter.write(
                  { method: m.MethodEnum.Post, path: l.encode("1/indexes/%s/clear", e.indexName) },
                  t,
                ),
                (r, s) => D(e)(r.taskID, s),
              ),
          ...
          as = e =>
            t =>
              l.createWaitablePromise(
                e.transporter.write({ method: m.MethodEnum.Delete, path: l.encode("1/indexes/%s", e.indexName) }, t),
                (r, s) => D(e)(r.taskID, s),
              ),
          os = e =>
            (t, r) =>
              l.createWaitablePromise(yt(e)([t], r).then(s => ({ taskID: s.taskIDs[0] })), (s, n) => D(e)(s.taskID, n)),
          yt = e =>
            (t, r) => {
                ...
                d = () =>
                  ft(e)(s || "", g(u({}, a), { page: o })).then(b => {
                    for (let [f, p] of Object.entries(b.hits)) {
                      if (t(p)) {
                        return { object: p, position: parseInt(f, 10), page: o };
                      }
                    }
          ...
          ds = e =>
            (t, r) =>
              e.transporter.read({ method: m.MethodEnum.Get, path: l.encode("1/indexes/%s/%s", e.indexName, t) }, r),
          ps = () =>
            (e, t) => {
          ...
          hs = e =>
            (t, r) =>
              e.transporter.read(
                { method: m.MethodEnum.Get, path: l.encode("1/indexes/%s/rules/%s", e.indexName, t) },
                r,
              ),
          gt = e =>
            t =>
          ...
          gs = e =>
            (t, r) =>
              l.createWaitablePromise(
                Pt(e)([t], r).then(s => ({ objectID: s.objectIDs[0], taskID: s.taskIDs[0] })),
                (s, n) => D(e)(s.taskID, n),
              ),
          Pt = e =>
            (t, r) => {
          ...
          fs = e =>
            (t, r) => {
              let O = r || {},
                ...
                f = he({ appId: e.appId, transporter: e.transporter, indexName: b }),
                p = [],
          ...
          js = e =>
            (t, r) =>
              l.createWaitablePromise(
                he(e)([t], r).then(s => ({ objectID: s.objectIDs[0], taskID: s.taskIDs[0] })),
                (s, n) => D(e)(s.taskID, n),
              ),
          he = e =>
            (t, r) => {
          ...
          D = e =>
            (t, r) => l.createRetryablePromise(s => bt(e)(t, r).then(n => n.status !== "published" ? s() : void 0)),
          Ss = {
            AddObject: "addObject",
            Analytics: "analytics",
            Browser: "browse",
          ...
          Ds = { None: "none", StopIfEnoughMatches: "stopIfEnoughMatches" },
          Rs = {
            Synonym: "synonym",
          ...
          return {
            send(s) {
              return new Promise(n => {
                let a = qs.parse(s.url),
                  o = a.query === null ? a.pathname : `${a.pathname}?${a.query}`,
                  d = u({
                  ...
                  y = (a.protocol === "https:" ? vt : Rt).request(d, h => {
                    ...
                    h.on("data", O => S += O),
                      h.on("end", () => {
                        clearTimeout(f), clearTimeout(p), n({ status: h.statusCode || 0, content: S, isTimedOut: !1 });
                      });
                  }),
                  b = (h, S) =>
                    setTimeout(() => {
                  ...
                  f = b(s.connectTimeout, "Connection timeout"),
                  p;
                y.on("error", h => {
      ...
      var kt = I((pn, Tt) => {
        ...
        function wt(e, t, r) {
          let s = {
            ...
            userAgent: ks.createUserAgent(be.version).add({ segment: "Node.js", version: process.versions.node }),
          };
      ...
      var Ws = {};
      Vt(Ws, { default: () => Ks });
      var Oe = C(require("@yarnpkg/core")),
        E = C(require("@yarnpkg/core")),
        Ie = C(require("@yarnpkg/plugin-essentials")),
        Ht = C(require("semver"));
      var se = C(require("@yarnpkg/core")),
        Nt = C(Ut()),
        Cs = "e8e1bd300d860104bb8c58453ffa1eb4",
        Us = "OFCNCOG2CU",
        Wt = async (e, t) => {
          var a;
          let r = se.structUtils.stringifyIdent(e), n = Ns(t).initIndex("npm-search");
          try {
            return ((a = (await n.getObject(r, { attributesToRetrieve: ["types"] })).types) == null ? void 0 : a.ts)
              === "definitely-typed";
          } catch (o) {
            return !1;
          }
        ...
        Ns = e =>
          (0, Nt.default)(Us, Cs, {
            requester: {
              async send(r) {
                try {
                  let s = await se.httpUtils.request(r.url, r.data || null, { configuration: e, headers: r.headers });
      ...
      var _t = e => e.scope ? `${e.scope}__${e.name}` : `${e.name}`,
        Hs = async (e, t, r, s) => {
          ...
          if (typeof O != "undefined") for (let [P, x] of O) e.manifest[P].set(x.identHash, x);
          else {
            try {
        ...
        _s = async (e, t, r) => {
          ...
          for (let a of Oe.Manifest.allDependencies) {
            typeof e.manifest[a].get(n.identHash) != "undefined"
              && e.manifest[a].delete(n.identHash);
          }
        },
        Fs = (e, t) => {
